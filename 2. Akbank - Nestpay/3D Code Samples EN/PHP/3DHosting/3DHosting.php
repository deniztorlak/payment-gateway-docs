...
$clientId = "520040000";			//Merchant Id defined by bank to user
$amount = "9.95";					//Transaction amount
$oid = "";							//Order Id. Must be unique. If left blank, system will generate a unique one.

$okUrl = "http://localhost:88/3DHosting/3DHostingPaymentPage.php";		//URL which client be redirected if authentication is successful
$failUrl = "http://localhost:88/3DHosting/3DHostingPaymentPage.php";	//URL which client be redirected if authentication is not successful

$rnd = microtime();				//A random number, such as date/time
$currencyVal = "949";			//Currency code, 949 for TL, ISO_4217 standard
$storekey = "12345BKT";			//Store key value, defined by bank.
$storetype = "3d_hosting";	//3D authentication model
