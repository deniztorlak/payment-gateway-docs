...
<body>
    <%
        ...
        string okUrl = "http://localhost:4362/3DPaySample/3DPayResultPage.aspx";                      //URL which client be redirected if authentication is successful
        string failUrl = "http://localhost:4362/3DPaySample/3DPayResultPage.aspx";                    //URL which client be redirected if authentication is not successful
        string rnd = DateTime.Now.ToString();           //A random number, such as date/time

        string instalment = "";                             //Instalment count, if there's no instalment should left blank
        string transactionType = "Auth";                      //transaction type
        string storekey = "123456";                   //Store key value, defined by bank.ı
        ...
        string hashstr = clientId + oid + amount + okUrl + failUrl + transactionType + instalment + rnd + storekey;
