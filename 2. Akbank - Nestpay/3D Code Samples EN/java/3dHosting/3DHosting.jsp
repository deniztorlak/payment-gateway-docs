...
<html>
    ...
    <body>
        ...
        String clientId = "520040000";     	//Merchant Id defined by bank to user
        String amount = "9.95";            	//Transaction amount
        String oid = "";                   	//Order Id. Must be uniuqe. If left blank, system will generate a unique one.
        String okUrl = "http://localhost/3DHosting/3DHostingPaymentPage.jsp";    		//URL which client be redirected if authentication is successful
        String failUrl = "http://localhost/3DHosting/3DHostingPaymentPage.jsp"; 		//URL which client be redirected if authentication is not successful
        ...
        String storekey="12345BKT";           //Store key value, defined by bank.
