...
<body>
    <%
        ...
        strProvisionPassword = "XXXXXXXX" 'TerminalProvUserID þifresi
        strSuccessURL = "https://<sunucu_adresi>/Gate3DEngineCallBack.asp"
        strErrorURL = "https://<sunucu_adresi>/Gate3DEngineCallBack.asp"
        strCompanyName = "TEST MAGAZA"
        strlang = "tr"
        strrefreshtime = "10"
    ...
    <form action="https://sanalposprov.garanti.com.tr/servlet/gt3dengine" method="post">
        ...
        <input type="hidden" name="secure3dsecuritylevel" value="OOS_PAY" />
        ...
        <input type="hidden" name="refreshtime" value="<%=strrefreshtime %>" />
        <!---
