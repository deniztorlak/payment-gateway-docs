...
<body>
    <%
        ...
        strType = "sales"
        strAmount = "100" 'Ýþlem Tutarý 1.00için 100 gönderilmeli
        strCurrencyCode = "949"
        ...
        strSuccessURL = "http://<sunucu_adresi>/Gate3DEngineCallBack.asp"
        strErrorURL = "http://<sunucu_adresi>/Gate3DEngineCallBack.asp"
