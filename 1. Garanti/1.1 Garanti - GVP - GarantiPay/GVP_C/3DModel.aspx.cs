...
{
    public partial class _DModel : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                string strTerminalMerchantID = "XXXXXXXX"; //Üye İşyeri Numarası
                string strStoreKey = "XXXXXXXX"; //3D Secure şifresi
                string strProvisionPassword = "XXXXXXXX"; //TerminalProvUserID şifresi
                string strSuccessURL = "http://<sunucu_adresi>/3DModelResults.aspx";
                string strErrorURL = "http://<sunucu_adresi>/3DModelResults.aspx";
