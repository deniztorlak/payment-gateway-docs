...
<body>
    <%
        ...
        If strMDStatus = 1 Or strMDStatus = 2 Or strMDStatus = 3 Or strMDStatus = 4 Then
            ...
            strProvisionPassword = "123qweASD" 'Terminal UserID þifresi
            ...
            strHostAddress = "https://sanalposprovtest.garanti.com.tr/VPServlet" 'Provizyon için xml'in post edileceði adres
            ...
            strXML = "<?xml version=""1.0"" encoding=""UTF-8""?>" & _
                     ...
                     "<Order><OrderID>" & strOrderID & "</OrderID><GroupID></GroupID><AddressList><Address><Type>S</Type><Name></Name><LastName></LastName><Company></Company><Text>Gaziosmanpaþa Bulvarý No:5 Çankaya/Konak/ÝZMÝR Türkiye</Text><District></District><City></City><PostalCode></PostalCode><Country></Country><PhoneNumber></PhoneNumber></Address></AddressList></Order>" & _
                     "<Transaction>" & _
