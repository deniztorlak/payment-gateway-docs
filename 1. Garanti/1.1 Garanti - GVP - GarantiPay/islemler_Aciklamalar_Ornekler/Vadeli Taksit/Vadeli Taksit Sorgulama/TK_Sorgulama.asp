...
<body>
    <%
        ...
        strType = "extendedcredit"
        strAmount = "100" 'Ýþlem Tutarý
        strCurrencyCode = "949"
        strInstallmentCount = "" 'Taksit Sayýsý. Boþ gönderilirse taksit yapýlmaz
        strTerminalUserID = "PROVAUT"
        strOrderID = "DENEME123456"
        strCustomeripaddress = Request.ServerVariables("REMOTE_ADDR")
        strcustomeremailaddress = "eticaret@garanti.com.tr"
        strTerminalID = "*******"
        strTerminalID_ = "0"&strTerminalID 'TerminalID baþýna 0 ile 9 digit yapýlmalý
        strTerminalMerchantID = "*******" 'MerchantID (Üye iþyeri no) 
        strStoreKey = "*******************" '3D Secure þifreniz
        strProvisionPassword = "******" 'SanalPos þifreniz   (PROVAUT kullanýcýsýnýn þifresi) 
        strSuccessURL = "http://localhost/GVP/TK_Results.asp"
        strErrorURL = "http://localhost/GVP/TK_Results.asp"
