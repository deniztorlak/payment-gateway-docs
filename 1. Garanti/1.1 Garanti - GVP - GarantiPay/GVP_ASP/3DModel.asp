...
<body>
    <%
        ...
        strTerminalMerchantID = "XXXXXXXX" 'Üye Ýþyeri Numarasý
        strStoreKey = "XXXXXXXX" '3D Secure þifreniz
        strProvisionPassword = "XXXXXXXX" 'TerminalProvUserID þifresi
        strSuccessURL = "https://<sunucu_adresi>/3DModelResults.asp"
        strErrorURL = "https://<sunucu_adresi>/3DModelResults.asp"
