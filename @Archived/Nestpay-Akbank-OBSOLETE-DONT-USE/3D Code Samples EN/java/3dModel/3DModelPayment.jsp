...
<html>
    ...
    <%
    	...
    	if (paramsval.equals(hashparamsval) && hash.equals(hashparam)) //hash generated in this page, hash returned and hash generated from parsed parameters should be same
    	{
    		...
    		String name = "xxxxxxxx"; 		//API user name
    		String password = "XXXXXXXX"; 	//API password
    ...
    %>
            ...
            <%
               String paymentHost = "<payment_gateway>"; //payment gateway server name (like: testsanalpos.est.com.tr)
               String api = "<apiserver_path>"; 		//api server path (like: /servlet/cc5ApiServer)
