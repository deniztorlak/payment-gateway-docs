...
<body>
    ...
    <center>
        ...
        <%
            ...
            okUrl = "http://localhost:48857/3DHostingResultPage.asp"                      'URL which client be redirected if authentication is successful
            failUrl = "http://localhost:48857/3DHostingResultPage.asp"                    'URL which client be redirected if authentication is not successful
            rndVal = now()	                            'A random number, such as date/time

            currencyVal = "008"                         'Currency code, 949 for TL, ISO_4217 standard
