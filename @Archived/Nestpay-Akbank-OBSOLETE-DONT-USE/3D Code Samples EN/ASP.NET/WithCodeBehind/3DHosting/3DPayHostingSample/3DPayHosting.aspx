...
<body>
    ...
    <center>
        ...
        <%
            ...
            string clientId = "1300000011";                   //Merchant Id defined by bank to user
            string amount = "9.95";                         //Transaction amount
            string oid = "";                                //Order Id. Must be unique. If left blank, system will generate a unique one.
            string okUrl = "http://localhost:3087/3DPayHostingSample/3DPayHostingResultPage.aspx";                      //URL which client be redirected if authentication is successful
            string failUrl = "http://localhost:3087/3DPayHostingSample/3DPayHostingResultPage.aspx";                    //URL which client be redirected if authentication is not successful
